...
void main() {
  ...
  // This test emulate a simple use case with a fake reader and a door spy.
  // We are checking if the door is opening when the badge is between his working hours,
  // and the door is open today (default is opened).
  test('BasicDoorCheckWhenInWorkingHoursButDoorIsNotOpenToday', () {
    final DoorSpy doorSpy = DoorSpy(
      beginHour: 8,
      endHour: 17,
    );
    ...
    expect(doorSpy.isOpenToday, true);
  });

  // This test emulate a simple use case with a fake reader and a door spy.
  // We are checking if the door is opening when the badge is between his working hours,
  // and the door is locked for today.
  test('BasicDoorCheckWhenInWorkingHoursButDoorIsNotOpenToday', () {
    final DoorSpy doorSpy = DoorSpy(
      beginHour: 8,
      endHour: 17,
    ...
    expect(doorSpy.isOpenToday, false);
  });
}
